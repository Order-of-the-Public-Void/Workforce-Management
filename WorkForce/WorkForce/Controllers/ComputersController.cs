...
namespace WorkForce.Controllers
{
    public class ComputersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ComputerId,EmployeeId")] Computers computers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ComputerId,EmployeeId")] Computers computers)
        {
            if (ModelState.IsValid)
            {
